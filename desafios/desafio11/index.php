...
<body>
    ...
    <section>
        ...
        <p>O produto que custava R$ <?= number_format($preco,2,",",".") ?>, com <strong><?= $reaj ?>%</strong> de aumento vai passar a custar <strong>R$ <?= number_format($novo,2,",",".") ?></strong> a partir de agora.</p>
    </section>
    <script>
